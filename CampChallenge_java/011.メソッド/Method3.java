...
public class Method3 extends HttpServlet {
    ...
    void multiplication(int num, int ber, boolean bl, PrintWriter pw){
            int total = num * ber;
            if (bl == true){
                //Math.pow(a,b)は、aの値をb乗する時の表記
                pw.print(total + "の2乗は、" + Math.pow(total,2) );
            }else{
                pw.print("実行されません");
            }
        }
